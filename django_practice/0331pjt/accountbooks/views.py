...
# def check(request, category):
#     accountbook = AccountBook.objects.filter(category=category)

#     categories = []
#     for accountbook in AccountBook.objects.all():
#         if accountbook.category == category:
#             categories.append(accountbook.category)
...
#     }
#     return render(request, 'accountbooks/check.html', context)
